...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{asset('/losts')}}">Listagem de perdidos</a></li>
        <li class="active">Cadastro de Perdidos</li>
    </ol>
</section>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {!! Form::model($losts, ['class'=> 'form-horizontal', 'method' => 'PATCH', 'url' => 'losts/update/'.$losts->id]) !!}
                @else 
                {!! Form::open(['action' => ['LostController@store'], 'class'=> 'form-horizontal', 'method' => 'POST'])!!}
                @endif
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="item">Item Perdido<h11>*</h11></label>  
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-2 control-label" for="loss_date">Data da Perda</label>
                    <div class="col-md-2">
                    ...
                    <label class="col-md-2 control-label" for="date_found">Data da Perda</label>
                    <div class="col-md-2">
                        <input id="date_found" name="date_found" class="form-control date-mask" placeholder="dd/mm/aaaa" type="date" maxlength="10" 
                        OnKeyPress="formatar('dd/mm/aaaa', this)" value="{{ old('date_found') }}">
                    </div>
